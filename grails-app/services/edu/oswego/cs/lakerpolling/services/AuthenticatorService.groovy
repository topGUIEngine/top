...
import edu.oswego.cs.lakerpolling.models.authentication.OAuthId
import edu.oswego.cs.lakerpolling.models.authentication.User
...
class AuthenticatorService {
    ...
    User getOrMakerUser(String email, String first, String last, String imageUrl, String subj) {
        ...
        if (temp == null) {
            temp = new User(email: email, firstName: first,
                    lastName: last, imageUrl: imageUrl, subject: subj)
